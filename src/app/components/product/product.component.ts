...
export class ProductComponent implements OnInit {
  ...
  product2: any = { productId: 2, productName: 'Masa', categoryId: 1, unitPrice: 5 };
  product3: any = { productId: 3, productName: 'Mouse', categoryId: 1, unitPrice: 5 };
  product4: any = { productId: 4, productName: 'Kalem', categoryId: 1, unitPrice: 5 };
  product5: any = { productId: 5, productName: 'Bardak2', categoryId: 1, unitPrice: 5 };
